    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-3 rounded-lg bg-black/40 border border-white/10 px-4 py-3">
        <button
          ...
          aria-label={
            autoPlay ? t("playback.pause_aria") : t("playback.play_aria")
          }
        ...
        {showVolume && onVolumeChange && onMutedToggle && (
          <div className="flex items-center gap-1.5 flex-shrink-0">
            <button
              ...
              aria-label={
                muted ? t("playback.unmute_aria") : t("playback.mute_aria")
              }
              aria-pressed={muted}
            ...
            <input
              ...
              aria-valuetext={tf("playback.volume_valuetext", {
                pct: muted ? 0 : volumePct,
              })}
        ...
        {onPlaybackRateChange && (
          <div className="flex items-center gap-1 flex-shrink-0">
            <div
              ...
              role="group"
              aria-label={t("playback.rate_presets_aria")}
            >
              {PLAYBACK_RATE_PRESETS.map((preset) => {
                ...
                return (
                  <button
                    ...
                    title={tf("playback.rate_preset", {
                      rate: preset.toFixed(1),
                    })}
                    aria-label={tf("playback.rate_preset_aria", {
                      rate: preset.toFixed(1),
                    })}
                    aria-pressed={active}
            ...
            <span
              className="text-[10px] text-white/35 font-mono w-7 text-right"
              aria-hidden="true"
            >
            ...
            <input
              ...
              value={ratePct}
              onChange={(e) =>
                onPlaybackRateChange(Number(e.target.value) / 100)
              }
              ...
              aria-valuetext={tf("playback.rate_valuetext", {
        ...
        {onLoopToggle && (
          <button
            ...
            aria-label={
              loopEnabled
                ? t("playback.loop_off_aria")
                : t("playback.loop_on_aria")
            }
