...
export async function copyRenderSpecToClipboard(spec: RenderSpec): Promise<void> {
...
export function SpecViewer({ spec }: SpecViewerProps) {
  ...
  return (
    <div className="mt-3 rounded-lg bg-white/5 border border-white/10 p-3">
      ...
      <p className="text-xs text-cyan-300 font-mono leading-relaxed" data-testid="spec-summary">
        {summaryLine}
      </p>
    </div>
  )
