...
const { SpecViewer, downloadRenderSpec, copyRenderSpecToClipboard } = SpecViewerModule
...
it('renders summary and download button', () => {
  ...
  expect(screen.getByTestId('spec-summary')).toHaveTextContent('180s · 128 BPM · 1 keyframes')
  expect(
