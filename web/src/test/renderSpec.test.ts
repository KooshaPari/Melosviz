...
import { specToSceneParams, hexToRgb } from "../renderSpec";
  ...
  it("multi-keyframe: picks correct segment", () => {
    const multiSpec: RenderSpec = {
      ...
      keyframes: [
        {
          t: 0,
          camera: { distance: 1, azimuth: 0, elevation: 0 },
          color: { primary: "#ff0000", secondary: "#000000", brightness: 0 },
        },
        {
          t: 0.5,
          camera: { distance: 5, azimuth: 0, elevation: 0 },
          color: { primary: "#00ff00", secondary: "#000000", brightness: 0.5 },
        },
        {
          t: 1,
          camera: { distance: 9, azimuth: 0, elevation: 0 },
          color: { primary: "#0000ff", secondary: "#000000", brightness: 1 },
        },
      ],
    };
