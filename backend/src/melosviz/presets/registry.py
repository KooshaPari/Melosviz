    ...
    def __init__(self) -> None:
        self._presets: dict[GenreTheme, ThemePreset] = {
            ...
            GenreTheme.ENERGETIC: ThemePreset(
                ...
                mood="driven",
                notes=(
                    "High-energy geometry and quick transitions built "
                    "around hot pink and electric orange."
                ),
            ),
            GenreTheme.AMBIENT: ThemePreset(
                ...
                mood="meditative",
                notes=(
                    "Teal and purple gradients with slow evolving "
                    "organic flow for immersive passages."
                ),
            ),
            ...
            GenreTheme.RETRO_DISCO: ThemePreset(
                ...
                mood="playful",
                notes=(
                    "Deep magenta core with chrome and rainbow "
                    "accents, emphasizing radial starburst motifs."
                ),
            ),
            ...
            GenreTheme.EUPHORIA: ThemePreset(
                ...
                mood="anthemic",
                notes=(
                    "Bold rainbow gradients and expanding forms "
                    "designed for uplifting crowd energy."
                ),
            ),
        }
