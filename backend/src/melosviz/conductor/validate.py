...
class ValidationReport:
    ...
    def to_dict(self) -> dict:
        d: dict[str, Any] = {
            ...
            "severity_counts": dict(self.summary),
            "ok": not self.has_errors,
            "error_count": int(self.summary.get("error", 0)),
            "warning_count": int(self.summary.get("warning", 0)),
            "info_count": int(self.summary.get("info", 0)),
