...
| G-C03-01 | C03 | L30.11 | No sccache/nextest/hyperfine timing budget gate | M | ci | `audit/.lane-c03/C03.md` | open | WBS-P1.11 | C03 L30.11 |
...
| G-C06-02 | C06 | L52 | No SOURCE_DATE_EPOCH / bit-identical release check | H | ci | `audit/.lane-c06/C06.md` L52 | open | WBS-P1.5 | C06 L52 |
...
| G-C10-01 | C10 | L96 | Token SoT not shared (desktop inline vs web subset) | M | unit | `desktop/assets/brand/tokens.css`; `web/src/styles/brand.css` | open | WBS-P3.2 | C10 L96 |
| G-C10-02 | C10 | L105 | No shared design-system package | M | doc | `audit/.lane-c10/C10.md` L105 | open | WBS-P3.2 | C10 L105 |
